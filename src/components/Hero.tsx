        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left animate-fade-in-up">
            ...
            <p className="text-lg text-gray-600 mb-8 max-w-2xl">
              Final-year ECE student passionate about IoT, web development, and sustainable technology. 
              Building innovative solutions that bridge hardware and software for a better tomorrow.
            </p>
            ...
            <div className="flex gap-4 justify-center lg:justify-start">
              <Button variant="ghost" size="icon" className="hover:text-primary" asChild>
                <a href="https://github.com/Aswin-2266" target="_blank" rel="noopener noreferrer">
                  <Github size={24} />
                </a>
              </Button>
              <Button variant="ghost" size="icon" className="hover:text-primary" asChild>
                <a href="https://linkedin.com/in/aswin41" target="_blank" rel="noopener noreferrer">
                  <Linkedin size={24} />
                </a>
              </Button>
              <Button variant="ghost" size="icon" className="hover:text-primary" onClick={scrollToContact}>
                <Mail size={24} />
              </Button>
            </div>
          </div>
